...
export default function Sidebar({
  ...
  useEffect(() => addListener(handleTitleUpdate), [addListener, handleTitleUpdate]);
  ...
  const sidebarContent = (
    <aside className="flex h-full w-[280px] flex-col border-r bg-sidebar text-sidebar-foreground">
      ...
      <div className="flex items-center gap-3 px-4 py-3">
        ...
        <Tooltip>
          <TooltipTrigger
            className="inline-flex h-8 w-8 shrink-0 cursor-pointer items-center justify-center rounded-md text-muted-foreground transition-colors hover:bg-accent hover:text-foreground"
            onClick={onLogout}
          >
